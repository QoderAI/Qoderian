import { QoderSessionManager } from '@/qoder/runtime/qoder-session-manager';

describe('QoderSessionManager', () => {
  let manager: QoderSessionManager;

  beforeEach(() => {
    manager = new QoderSessionManager();
  });
  ...
  describe('getSessionId and setSessionId', () => {
    ...
    it('should set session model when defaultModel is provided', () => {
      manager.setSessionId('test-session', 'qoder-sonnet-4-5');
  ...
  describe('pending model', () => {
    it('should set and clear pending model without throwing', () => {
      expect(() => manager.setPendingModel('qoder-opus-4-5')).not.toThrow();
  ...
  describe('captureSession', () => {
    it('should capture session ID and pending model', () => {
      manager.setPendingModel('qoder-opus-4-5');
