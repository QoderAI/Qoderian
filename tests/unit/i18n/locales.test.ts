...
describe('locale files', () => {
  ...
  it('localizes the recent settings and chat additions', () => {
  ...
  it('documents commands and skills as separate Qoder project concepts', () => {
    expect(english['settings.slashCommands.commandsDesc']).toContain('.qoder/commands/*.md');
    expect(english['settings.slashCommands.skillsDesc']).toContain(
