...
} from '@/features/chat/rendering/write-edit-renderer';
...
describe('WriteEditRenderer', () => {
  describe('createWriteEditBlock', () => {
    ...
    it('should start collapsed by default', () => {
      ...
      expect(state.contentEl.hasClass('qoderian-hidden')).toBe(true);
    ...
    it('should start expanded when requested', () => {
      ...
      expect(state.contentEl.hasClass('qoderian-hidden')).toBe(false);
  ...
  describe('renderStoredWriteEdit', () => {
    ...
    it('should start collapsed by default', () => {
      ...
      const block = renderStoredWriteEdit(parentEl, toolCall);
      const headerEl = block.querySelector('.qoderian-write-edit-header');
      const contentEl = block.querySelector('.qoderian-write-edit-content');

      expect(block.hasClass('expanded')).toBe(false);
      expect(contentEl?.hasClass('qoderian-hidden')).toBe(true);
