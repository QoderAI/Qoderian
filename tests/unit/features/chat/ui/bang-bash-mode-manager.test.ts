import { BangBashModeManager } from '@/features/chat/ui/bang-bash-mode-manager';
...
describe('BangBashModeManager', () => {
  it('should enter bash mode on ! keystroke when input is empty', () => {
    ...
    expect(wrapper.addClass).toHaveBeenCalledWith('qoderian-input-bang-bash-mode');
  });
  ...
  it('should remove bash mode class and restore placeholder on destroy()', () => {
    ...
    expect(wrapper.removeClass).toHaveBeenCalledWith('qoderian-input-bang-bash-mode');
