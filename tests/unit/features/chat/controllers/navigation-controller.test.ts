import { NavigationController, type NavigationControllerDeps } from '@/features/chat/controllers/navigation-controller';
...
describe('NavigationController', () => {
  ...
  describe('initialization', () => {
    ...
    it('adds focusable CSS class to messagesEl', () => {
      controller.initialize();
      expect(messagesEl.hasClass('qoderian-messages-focusable')).toBe(true);
    });
