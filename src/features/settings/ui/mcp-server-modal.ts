...
import { parseCommand } from '../../../qoder/mcp/command-line';
...
export class McpServerModal extends Modal {
  ...
  onOpen() {
    ...
    this.modalEl.addClass('qoderian-mcp-modal');
    ...
    this.typeFieldsEl = contentEl.createDiv({ cls: 'qoderian-mcp-type-fields' });
    this.renderTypeFields();
    ...
    const buttonContainer = contentEl.createDiv({ cls: 'qoderian-mcp-buttons' });
  ...
  private renderStdioFields() {
    ...
    cmdSetting.settingEl.addClass('qoderian-mcp-cmd-setting');

    const cmdTextarea = cmdSetting.controlEl.createEl('textarea', {
      cls: 'qoderian-mcp-cmd-textarea',
    });
    ...
    envSetting.settingEl.addClass('qoderian-mcp-env-setting');

    const envTextarea = envSetting.controlEl.createEl('textarea', {
      cls: 'qoderian-mcp-env-textarea',
    });
  ...
  private renderUrlFields() {
    ...
    headersSetting.settingEl.addClass('qoderian-mcp-env-setting');
