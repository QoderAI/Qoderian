import type { McpServerConfig, ParsedMcpConfig } from '../../core/types';
import { isValidMcpServerConfig } from '../../core/types';
 ...
 *
 * Formats supported:
 * 1. Full Qoder CLI format: { "mcpServers": { "name": {...} } }
...
export function parseClipboardConfig(json: string): ParsedMcpConfig {
  try {
    ...
    // Format 1: Full Qoder CLI format
