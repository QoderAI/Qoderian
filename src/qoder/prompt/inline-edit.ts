import { getTodayDate } from '../../core/time/date';
import type {
  InlineEditCursorRequest,
  InlineEditRequest,
  InlineEditResult,
} from '../../core/types/services';
import { appendContextFiles } from './context/prompt-context';
...
You are **Qoderian**, an expert editor and writing assistant embedded in Obsidian. You help users refine their text, answer questions, and generate content with high precision.
