...
import type { EffortLevel,QoderModel } from '../models/model-catalog';
...
export interface QoderEnsureReadyOptions extends ChatRuntimeEnsureReadyOptions {
...
export interface SessionState {
  ...
  sessionModel: QoderModel | null;
  pendingSessionModel: QoderModel | null;
