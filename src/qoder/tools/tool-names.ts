/** Tool names emitted by Qoder CLI and consumed by the plugin. */
...
// Runtime-managed tools exposed by Qoder CLI.
...
/** Tools hidden from rendering when a Qoder subagent block is shown. */
